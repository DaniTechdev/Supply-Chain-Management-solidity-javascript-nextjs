...
contract Tracking {
    ...
    //creating another shipment type struct for displaying purpose
    ...
    //I used indexed twice but not more than three for filtering the data
    ...
    function startShipment(address _sender, address _receiver, uint256 _index) public {
        ...
        TypeShipment storages typeShipment = typeShipments[_index];
        ...
        event ShipmentInTransit(_sender, _receiver, shipment.pickupTime);
    }
    ...
    function completeShipment (address _sender, address _receiver, uint256 _index ) public {
        ...
        typeShipement.deliveryTime = block.timestamp;
    ...
    function getShipment (address _sender, uint256 _index) public view returns( address, address,
    uint256,uint256, uint256,uint256, uint256,ShipmentStatus, bool){
    ...
    function getAllTranactions() public view return (TypeShipment[] memory){
